      ...
      <div className="mb-8">
        <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href={`/poll/${id}/present`}
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 rounded-lg border-2 border-charcoal-200 text-charcoal-700 hover:border-iris-purple hover:text-iris-purple transition-all duration-200"
